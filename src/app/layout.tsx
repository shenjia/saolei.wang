...
import { IconGear, IconLogout, IconPerson, IconUpload } from "@/components/MenuIcons";
      ...
      <body>
        <div id="header">
          <div className="wrapper">
            ...
            {/* 移动版（≤768px）导航：三横线菜单 + 登录头像；桌面由 CSS 隐藏 */}
            <MobileNav
              user={
                session ? { uid: session.uid, displayName, avatarUrl } : null
              }
            />
          </div>
        </div>
